...
Estimates of forest carbon and tree-level biomass over time are useful for a variaty of applications, including: -understanding drivers of growth and mortality -quantifying the relative roles of growth, mortality, and regeneration in driving forest C over time

## Introduction to the tutorial and State-Space Model

1.  Introduce the state-space approach that links tree ring data with forest census data
