...
3.  Estimating Biomass from Ring width & Census data (no uncertainty)
4.  Bayesian Growth Model Introduction
5.  Ring-width only model
6.  CENSUS only model
7.  Ring-width + CENSUS data
8.  Comparing all three estimates
